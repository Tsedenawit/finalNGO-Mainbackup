...
export default function Footer(){
    return(
        <footer className="bg-gray-900 text-white">
            <div className="md:flex md:justify-between md:items-center sm:px-12 px-4 bg- py-7 bg-[#ffffff19]">
            <div>
         <h1 className="lg:text-4xl text-3xl md:mb-0 mb-6 lg:leading-normal font-semibold
              md:w-2/5"><span className="text-teal-400 ">Support us </span>
        ...
        <span className="font-bold md:text-xl  text-yellow">Developed by Senay Alemneh</span>
